...
struct traits<thirdparty::Sophus::SE2<Scalar_, Options>> {
  using Scalar = Scalar_;
  using TranslationType = thirdparty::Sophus::Vector2<Scalar, Options>;
  using SO2Type = thirdparty::Sophus::SO2<Scalar, Options>;
};

template <class Scalar_, int Options>
struct traits<Map<thirdparty::Sophus::SE2<Scalar_>, Options>>
    : traits<thirdparty::Sophus::SE2<Scalar_, Options>> {
  using Scalar = Scalar_;
  using TranslationType = Map<thirdparty::Sophus::Vector2<Scalar>, Options>;
  using SO2Type = Map<thirdparty::Sophus::SO2<Scalar>, Options>;
};

template <class Scalar_, int Options>
struct traits<Map<thirdparty::Sophus::SE2<Scalar_> const, Options>>
    : traits<thirdparty::Sophus::SE2<Scalar_, Options> const> {
  using Scalar = Scalar_;
  using TranslationType = Map<thirdparty::Sophus::Vector2<Scalar> const, Options>;
  using SO2Type = Map<thirdparty::Sophus::SO2<Scalar> const, Options>;
};
}  // namespace internal
}  // namespace Eigen
...
class SE2Base {
 public:
  ...
  SOPHUS_FUNC Matrix<Scalar, num_parameters, DoF> Dx_this_mul_exp_x_at_0()
    ...
    thirdparty::Sophus::Vector2<Scalar> const c = unit_complex();
    Scalar o(0);
    J(0, 0) = o;
    J(0, 1) = o;
    J(0, 2) = -c[1];
  ...
  //
  SOPHUS_FUNC void setComplex(thirdparty::Sophus::Vector2<Scalar> const& complex) {
...
class SE2 : public SE2Base<SE2<Scalar_, Options>> {
 ...
 public:
  ...
  SOPHUS_FUNC static thirdparty::Sophus::Matrix<Scalar, num_parameters, DoF> Dx_exp_x(
    ...
    thirdparty::Sophus::Vector<Scalar, 2> upsilon = upsilon_theta.template head<2>();
  ...
  static SOPHUS_FUNC SE2 rot(Scalar const& x) {
    return SE2(SO2<Scalar>(x), thirdparty::Sophus::Vector2<Scalar>::Zero());
  }
...
template <class Scalar_, int Options>
class Map<thirdparty::Sophus::SE2<Scalar_>, Options>
    : public thirdparty::Sophus::SE2Base<Map<thirdparty::Sophus::SE2<Scalar_>, Options>> {
  using Base = thirdparty::Sophus::SE2Base<Map<thirdparty::Sophus::SE2<Scalar_>, Options>>;
 ...
 public:
  ...
  Map(Scalar* coeffs)
      : so2_(coeffs),
        translation_(coeffs + thirdparty::Sophus::SO2<Scalar>::num_parameters) {}

  // Mutator of SO3
  //
  SOPHUS_FUNC Map<thirdparty::Sophus::SO2<Scalar>, Options>& so2() { return so2_; }

  // Accessor of SO3
  //
  SOPHUS_FUNC Map<thirdparty::Sophus::SO2<Scalar>, Options> const& so2() const {
    return so2_;
  }

  // Mutator of translation vector
  //
  SOPHUS_FUNC Map<thirdparty::Sophus::Vector2<Scalar>, Options>& translation() {
    return translation_;
  }

  // Accessor of translation vector
  //
  SOPHUS_FUNC Map<thirdparty::Sophus::Vector2<Scalar>, Options> const& translation() const {
    return translation_;
  }

 protected:
  Map<thirdparty::Sophus::SO2<Scalar>, Options> so2_;
  Map<thirdparty::Sophus::Vector2<Scalar>, Options> translation_;
};
...
// Allows us to wrap SE2 objects around POD array.
template <class Scalar_, int Options>
class Map<thirdparty::Sophus::SE2<Scalar_> const, Options>
    : public thirdparty::Sophus::SE2Base<Map<thirdparty::Sophus::SE2<Scalar_> const, Options>> {
  using Base = thirdparty::Sophus::SE2Base<Map<thirdparty::Sophus::SE2<Scalar_> const, Options>>;
 ...
 public:
  ...
  // Accessor of SO3
  //
  SOPHUS_FUNC Map<thirdparty::Sophus::SO2<Scalar> const, Options> const& so2() const {
    return so2_;
  }

  // Accessor of translation vector
  //
  SOPHUS_FUNC Map<thirdparty::Sophus::Vector2<Scalar> const, Options> const& translation()
      const {
    return translation_;
  }

 protected:
  Map<thirdparty::Sophus::SO2<Scalar> const, Options> const so2_;
  Map<thirdparty::Sophus::Vector2<Scalar> const, Options> const translation_;
};
}  // namespace Eigen
