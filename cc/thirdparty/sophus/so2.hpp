...
struct traits<thirdparty::Sophus::SO2<Scalar_, Options>> {
  using Scalar = Scalar_;
  using ComplexType = thirdparty::Sophus::Vector2<Scalar, Options>;
};

template <class Scalar_, int Options>
struct traits<Map<thirdparty::Sophus::SO2<Scalar_>, Options>>
    : traits<thirdparty::Sophus::SO2<Scalar_, Options>> {
  using Scalar = Scalar_;
  using ComplexType = Map<thirdparty::Sophus::Vector2<Scalar>, Options>;
};

template <class Scalar_, int Options>
struct traits<Map<thirdparty::Sophus::SO2<Scalar_> const, Options>>
    : traits<thirdparty::Sophus::SO2<Scalar_, Options> const> {
  using Scalar = Scalar_;
  using ComplexType = Map<thirdparty::Sophus::Vector2<Scalar> const, Options>;
};
}  // namespace internal
}  // namespace Eigen
...
class SO2 : public SO2Base<SO2<Scalar_, Options>> {
 ...
 public:
  ...
  SOPHUS_FUNC static thirdparty::Sophus::Matrix<Scalar, num_parameters, DoF> Dx_exp_x(
    ...
    using std::cos;
    using std::sin;
    return thirdparty::Sophus::Matrix<Scalar, num_parameters, DoF>(-sin(theta), cos(theta));
  }
  ...
  Dx_exp_x_at_0() {
    return thirdparty::Sophus::Matrix<Scalar, num_parameters, DoF>(Scalar(0), Scalar(1));
  }
...
template <class Scalar_, int Options>
class Map<thirdparty::Sophus::SO2<Scalar_>, Options>
    : public thirdparty::Sophus::SO2Base<Map<thirdparty::Sophus::SO2<Scalar_>, Options>> {
  using Base = thirdparty::Sophus::SO2Base<Map<thirdparty::Sophus::SO2<Scalar_>, Options>>;
 ...
 public:
  ...
  // ``Base`` is friend so unit_complex_nonconst can be accessed from ``Base``.
  friend class thirdparty::Sophus::SO2Base<Map<thirdparty::Sophus::SO2<Scalar_>, Options>>;
  ...
  //
  SOPHUS_FUNC
  Map<thirdparty::Sophus::Vector2<Scalar>, Options> const& unit_complex() const {
    return unit_complex_;
  }
 ...
 protected:
  ...
  //
  SOPHUS_FUNC
  Map<thirdparty::Sophus::Vector2<Scalar>, Options>& unit_complex_nonconst() {
    return unit_complex_;
  }
...
// complex number / tuple).
template <class Scalar_, int Options>
class Map<thirdparty::Sophus::SO2<Scalar_> const, Options>
    : public thirdparty::Sophus::SO2Base<Map<thirdparty::Sophus::SO2<Scalar_> const, Options>> {
  using Base = thirdparty::Sophus::SO2Base<Map<thirdparty::Sophus::SO2<Scalar_> const, Options>>;
 ...
 public:
  ...
  // Accessor of unit complex number.
  //
  SOPHUS_FUNC Map<thirdparty::Sophus::Vector2<Scalar> const, Options> const& unit_complex()
      const {
    return unit_complex_;
  }
