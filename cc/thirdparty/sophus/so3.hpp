...
struct traits<thirdparty::Sophus::SO3<Scalar_, Options>> {
  using Scalar = Scalar_;
  using QuaternionType = Eigen::Quaternion<Scalar, Options>;
};

template <class Scalar_, int Options>
struct traits<Map<thirdparty::Sophus::SO3<Scalar_>, Options>>
    : traits<thirdparty::Sophus::SO3<Scalar_, Options>> {
  using Scalar = Scalar_;
  using QuaternionType = Map<Eigen::Quaternion<Scalar>, Options>;
};

template <class Scalar_, int Options>
struct traits<Map<thirdparty::Sophus::SO3<Scalar_> const, Options>>
    : traits<thirdparty::Sophus::SO3<Scalar_, Options> const> {
  using Scalar = Scalar_;
...
class SO3Base {
 public:
  ...
  SOPHUS_FUNC enable_if_t<std::is_floating_point<S>::value, S> angleX() const {
    thirdparty::Sophus::Matrix3<Scalar> R = matrix();
    thirdparty::Sophus::Matrix2<Scalar> Rx = R.template block<2, 2>(1, 1);
  ...
  SOPHUS_FUNC enable_if_t<std::is_floating_point<S>::value, S> angleY() const {
    thirdparty::Sophus::Matrix3<Scalar> R = matrix();
    thirdparty::Sophus::Matrix2<Scalar> Ry;
    // clang-format off
    Ry <<
      R(0, 0), R(2, 0),
      R(0, 2), R(2, 2);
  ...
  SOPHUS_FUNC enable_if_t<std::is_floating_point<S>::value, S> angleZ() const {
    thirdparty::Sophus::Matrix3<Scalar> R = matrix();
    thirdparty::Sophus::Matrix2<Scalar> Rz = R.template block<2, 2>(0, 0);
...
class SO3 : public SO3Base<SO3<Scalar_, Options>> {
 ...
 public:
  ...
  SOPHUS_FUNC static SO3<Scalar> expAndTheta(Tangent const& omega,
    ...
    *theta = sqrt(theta_sq);
    ...
    SOPHUS_ENSURE(abs(q.unit_quaternion().squaredNorm() - Scalar(1)) <
                      thirdparty::Sophus::Constants<Scalar>::epsilon(),
  ...
  fitToSO3(Transformation const& R) {
    return SO3(::thirdparty::Sophus::makeRotationMatrix(R));
  }
  ...
  static SOPHUS_FUNC SO3 rotX(Scalar const& x) {
    return SO3::exp(thirdparty::Sophus::Vector3<Scalar>(x, Scalar(0), Scalar(0)));
  }

  // Contruct y-axis rotation.
  //
  static SOPHUS_FUNC SO3 rotY(Scalar const& y) {
    return SO3::exp(thirdparty::Sophus::Vector3<Scalar>(Scalar(0), y, Scalar(0)));
  }

  // Contruct z-axis rotation.
  //
  static SOPHUS_FUNC SO3 rotZ(Scalar const& z) {
    return SO3::exp(thirdparty::Sophus::Vector3<Scalar>(Scalar(0), Scalar(0), z));
  }
  ...
  static SO3 sampleUniform(UniformRandomBitGenerator& generator) {
    ...
    thirdparty::Sophus::Vector3<Scalar> axis;
    Scalar nrm;
    do {
...
// quaternion).
template <class Scalar_, int Options>
class Map<thirdparty::Sophus::SO3<Scalar_>, Options>
    : public thirdparty::Sophus::SO3Base<Map<thirdparty::Sophus::SO3<Scalar_>, Options>> {
  using Base = thirdparty::Sophus::SO3Base<Map<thirdparty::Sophus::SO3<Scalar_>, Options>>;
 ...
 public:
  ...
  // ``Base`` is friend so unit_quaternion_nonconst can be accessed from
  // ``Base``.
  friend class thirdparty::Sophus::SO3Base<Map<thirdparty::Sophus::SO3<Scalar_>, Options>>;
...
// quaternion).
template <class Scalar_, int Options>
class Map<thirdparty::Sophus::SO3<Scalar_> const, Options>
    : public thirdparty::Sophus::SO3Base<Map<thirdparty::Sophus::SO3<Scalar_> const, Options>> {
  using Base = thirdparty::Sophus::SO3Base<Map<thirdparty::Sophus::SO3<Scalar_> const, Options>>;
